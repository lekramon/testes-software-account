...
public class Cliente {
	...
	public boolean equals(Object o) {
		...
		return id == cliente.id && idade == cliente.idade && ativo == cliente.ativo && idContaCorrente == cliente.idContaCorrente && nome.equals(cliente.nome) && email.equals(cliente.email);
	}

	@Override
	public int hashCode() {
		return Objects.hash(id, nome, idade, email, ativo, idContaCorrente);
	}

	public Cliente(int id, String nome, int idade, boolean b) {
    }
